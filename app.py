...
class ImageToPDFConverter:
    def __init__(self, root):
        print("Initializing ImageToPDFConverter...")
        self.root = root
        self.image_paths = []
    ...
    def select_images(self):
        ...
        print(f"Selected images: {self.image_paths}")
    ...
    def update_selected_images_listbox(self):
        ...
        print("Updated selected images listbox.")

    def convert_images_pdf(self):
        if not self.image_paths:
            print("No images selected. Conversion aborted.")
            return
        
        output_pdf_path = self.output_pdf_name.get() + ".pdf" if self.output_pdf_name.get() else "output.pdf"
        print(f"Converting images to PDF: {output_pdf_path}")
...
def main():
    print("Starting Image to PDF Converter...")
    root = tk.Tk()
